...
- Store : 상점 (모든 회원은 하나의 상점을 가짐 )
    - id, 상점이름, 상점소개, 판매상품, 구매한상품, 상점리뷰, 참여하는 채팅방
...
6. 회원 메시지 기능
    ...
    - 상점간의 1대1 메시지 전송기능
        - ChatRoom 생성 -> 상점 각각에 대한 Participant 생성 -> 각 Store 에 Participants 에 추가한다.
...
- [X] 자신의 상점 등록
- [X] 자신의 상점 수정
- [x] 자신의 상점 조회 :  등록한 판매 물품 목록, 구매한 상품 목록, 상점후기, 오픈일

### 포인트 관리
- [X] 포인트 충전 (연결된 자신의 계좌에서 충전)
- [X] 포인트 내보내기 (자신의 계좌로 내보내기)
- [X] 포인트 조회 (충전, 내보내기 내역 조회)
...
- [X] 물품 클릭시 상세정보 보기
- [ ] 상점 검색
- [X] 상점 클릭시 상점 상세정보 보기 ( 상점이름, 이미지, 상점소개, 리뷰, 판매중인 상품 표시)
